...
export const AIChatbot = ({ isOpen, onClose }: AIChatbotProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="w-full max-w-lg border-none bg-transparent p-0 shadow-none sm:rounded-3xl">
        <div
          className={`bg-white/90 dark:bg-slate-950/90 border border-white/40 dark:border-white/10 rounded-2xl shadow-[0_35px_120px_rgba(6,10,35,0.65)] backdrop-blur-2xl w-full ${
          ...
          <div className="flex items-center justify-between p-5 border-b border-white/30 dark:border-white/5 bg-gradient-to-r from-[#7c3aed] via-[#a855f7] to-[#22d3ee] text-white">
            ...
            <div className="flex items-center space-x-2">
              <Button
                ...
                className="text-white/80 hover:text-white hover:bg-white/20 p-2 h-9 w-9 rounded-lg transition-all duration-200"
              >
                {isMinimized ? (
